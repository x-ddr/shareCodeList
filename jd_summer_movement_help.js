...
!(async () => {
  ...
  // 助力
  let res = [], res2 = [];
  $.innerShInviteList = await getAuthorShareCode('https://gh.tryxd.cn/https://github.com/x-dr/shareCodeList/blob/main/summer_movement.json');
  res2 = await getAuthorShareCode('https://github.com/x-dr/shareCodeList/blob/main/summer_movement_one.json');
  $.ShInviteLists = []
  if (ShHelpAuthorFlag) {
